...
ЗАПРЕЩЕНО: «уникальный», «оптимальный», «сбалансированный подход», «индивидуальный», «замечательный», «рекомендуется». Не лей воду.
...
Пиши так же: конкретно, с цифрами, по делу. Упоминай кличку. Без emoji.""", max_tokens=800)
    return result or ""
